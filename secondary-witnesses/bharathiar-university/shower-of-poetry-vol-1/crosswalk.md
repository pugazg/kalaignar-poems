# Crosswalk — Shower of Poetry — Volume I

Initial title-level matching against the current repository. MATCHED rows are high-confidence work/item identities; POSSIBLE rows require payload comparison. Unmatched rows remain INVESTIGATE rather than being declared absent.
