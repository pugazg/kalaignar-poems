# அணையா விளக்கு அண்ணா — Audit

## Reset provenance

At the user's explicit request, the previous `poems/anaiya-vilakku-anna/` contents were deleted and the work was restarted from the newly supplied PDF. Previous transcription/metadata are not being reused as source authority.

## Source

- uploaded source: `TVA_BOK_0065770_அணையா_விளக்கு_அண்ணா(1).pdf`
- SHA-256: `f68ec53dc87f3b331397fe3c6d686613fb22fcb0af717b022513867cf6d030f4`
- file size: **109,709,692 bytes**
- physical scans: **19**
