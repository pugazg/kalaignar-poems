...
The user specified pages **145–152**, but this attached PDF has only **150 pages**. Pages **151–152 are unavailable in the controlling source currently supplied** and therefore are not assigned invented page records or inferred text.

No PDF scan index is being treated as a visible printed page number.
