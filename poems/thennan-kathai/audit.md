...
This description is contextual metadata only and is not imported into the poem body.
...
| `மாடுகள், ஆடுகள்` | `மாடுகளை, ஆடுகளை` |
| `மனிதர்கள்` | `மனிதர்களை` |
| `மேடுகள் வேள்விகளென` | `மேடுகளை வேள்விக்கென` |
| `நின்றன` | `நின்றான்` |
| `கோமான` | `கோமான்` |
| `பற்றுதல்` | `பற்றுதலை` |
| `முல்லைத்` | `மலைத்` |
