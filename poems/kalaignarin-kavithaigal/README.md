...
- physical PDF scans available: **150**;
- file size: **486,369,088 bytes**;
- source is image-based; no usable parsed text layer is available;
- printed title: **கலைஞரின் கவிதைகள்**;
- author line: **கலைஞர் மு. கருணாநிதி**;
- publisher visible in the preliminaries: **பாரதி பதிப்பகம்**;
- English imprint identifies a **fourth edition, March 1995** and printed price **Rs. 65.00**;
- source PDF itself is not committed to this repository.

## Critical source-completeness warning

The supplied 150-scan PDF is **not the complete printed book**.
...
This anthology includes works that also exist elsewhere in this repository as separate source witnesses, including at least:
...
The supplied source checksum is not yet recorded because the current attachment interface exposed the file size/page images but did not expose a SHA-256 value to the repository-writing tools. `metadata/source.md` records this explicitly as pending. The checksum must be filled from the exact supplied bytes as soon as a source-byte-capable pass is available; it must never be guessed.
