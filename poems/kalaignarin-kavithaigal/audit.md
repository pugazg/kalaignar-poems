...
- scan **9 / printed VIII** — fresh direct-source rereading establishes the sequence `வள்ளுவர் வள்ளலார்`; the previous residual pass had accidentally dropped `வள்ளலார்`. `தமிழ்ப் பண்பாளர்கள்` remains source-confirmed in place of the older `தமிழ்ப் பன்னாளர்கள்`; other compact prose remains unresolved.
