# Source metadata — குணநாயகர் நேரு
...
- source form: scanned image PDF; no usable parsed text layer.
...
The scan-2 `பதிப்புரை` explains that the booklet was issued during Pandit Nehru's centenary observance and includes a poem sung by Kalaignar at a 1970 poetry event in the Chennai University centenary hall together with Dr. Krishna Srinivas's English translation.

Scan 7 explicitly records the performance date as **14.11.1970** and the venue/context as the Chennai University centenary-hall poetry event at which the Chief Minister Kalaignar presided and sang the poem.
