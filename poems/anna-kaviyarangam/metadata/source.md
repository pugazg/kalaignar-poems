# Source metadata — அண்ணா கவியரங்கம்
...
- event date: **7.1.1968**;
- event/context: World Tamil Conference Anna kaviyarangam; Kalaignar chaired as Public Works Minister;
- work location: physical scans **119–124**.

## Controlling source identity

- filename: `TVA_PRL_0001502_முரசொலி_பொங்கல் மலர்_1968.pdf`;
- type: scanned image PDF;
- physical PDF page count: **136**;
- file size: **58,026,496 bytes**;
- SHA-256: `5f9cc505038ae1c3f91cbd0b50c0b6692b54baeee40fffef1fcdc8d213a146ce`;
- repository stores source PDF: **No**.

## Scan condition / typography

- periodical print with decorative illustrations and uneven scan contrast;
- scans 120–124 are landscape-oriented page images with two text columns;
- period historical Tamil glyph forms can resemble modern `உ/ள` components;
